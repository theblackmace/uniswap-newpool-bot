...
const runBot = () => {
    console.log('Arbitrum Bot instance running.....');
...
const tweet = async () => {
    ...
    const tweetText = 
    `A new liquidity pool was created using the Uniswap v3 Factory on Arbitrum 🦄
    Pool: https://arbiscan.io/address/${poolArr[4]}
    Fee: ${poolArr[2]/10000}%
