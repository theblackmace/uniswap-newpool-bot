...
const runBot = () => {
    console.log('Optimism Bot instance running.....');
...
const tweet = async () => {
    ...
    const tweetText = 
    `A new liquidity pool was created using the Uniswap v3 Factory on Optimism 🦄
    Pool: https://optimistic.etherscan.io/address/${poolArr[4]}
    Fee: ${poolArr[2]/10000}%
