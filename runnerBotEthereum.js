...
const runBot = () => {
    console.log('Ethereum Bot instance running.....');
...
const tweet = async () => {
    ...
    const tweetText = 
    `A new liquidity pool was created using the Uniswap v3 Factory on Ethereum 🦄
    Pool: https://etherscan.io/address/${poolArr[4]}
    Fee: ${poolArr[2]/10000}%
